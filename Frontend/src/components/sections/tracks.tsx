...
const tracks = [
  ...
  },
  {
    ...
    weeks: [
      "Days 1–7: Web fundamentals — HTML, CSS, responsive design & JavaScript ES6+",
      "Days 8–14: React, components, hooks & modern frontend development",
      "Days 15–18: Node.js, Express, REST APIs, MongoDB, authentication & Git",
      "Day 19: Mock Interview 1 — individual technical + HR round with written feedback",
      "Day 20: Live full-stack project presentation + portfolio review + placement matching",
    ],
    isSkillDev: false,
    duration: "21 days",
  },
