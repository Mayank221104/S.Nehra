...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "S.Nehra" },
      { name: "description", content: "S.Nehra: Professional Career Accelerator" },
      { name: "author", content: "S.Nehra" },
      { property: "og:title", content: "S.Nehra" },
      { property: "og:description", content: "S.Nehra: Professional Career Accelerator" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@SNehraCareer" },
    ],
    links: [
